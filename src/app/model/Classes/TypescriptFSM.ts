...
export class TypescriptFSM implements FSM{    
    ...
    constructor(){
        ...
        this.NotAcceptingStates = [TypescriptFSMStates.Initial, TypescriptFSMStates.StringLiteralSingleQuotePart, TypescriptFSMStates.StringLiteralDoubleQuotePart, TypescriptFSMStates.MultiLineCommentPart, TypescriptFSMStates.MultiLineCommentEndStart, TypescriptFSMStates.EnteroDecimalStart, TypescriptFSMStates.ExpontenteStart, TypescriptFSMStates.ExponenteNegativoStart, TypescriptFSMStates.NumHexStart, TypescriptFSMStates.NumHexX];
